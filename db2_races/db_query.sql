 ...
 */
 ...
 -- В ответе примера в одной строке одна точность, а вдругой другая точность.
 ...
 */
 ...
 -- Примере ответа в задаче 5 увидел расхождение между условием задачи и привидённым ответом
